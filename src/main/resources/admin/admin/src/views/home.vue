<template>
	<div class="home-content">
		...
		<div class="type2">
			...
			<div id="yingpinxinxiChart1" class="echarts2 animate__animated" v-if="isAuth('yingpinxinxi','首页统计')"></div>
		</div>
	</div>
</template>
<script>
	...
	methods:{
		handleScroll() {
			let arr = [
				...
				{id:'zhaopinxinxiChart1',css:'animate__fadeInUp'},
				{id:'yingpinxinxiChart1',css:'animate__fadeInUp'},
			]
...
// 1234 竖
		yingpinxinxiChat1() {
			this.$nextTick(()=>{
				...
				var yingpinxinxiChart1 = echarts.init(document.getElementById("yingpinxinxiChart1"),'macarons');
				this.$http({
