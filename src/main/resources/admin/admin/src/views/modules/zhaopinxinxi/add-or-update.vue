	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="upload" v-else-if="ruleForm.zhaopinfengmian" label="招聘封面" prop="zhaopinfengmian" >
					<img v-if="ruleForm.zhaopinfengmian.substring(0,4)=='http'&&ruleForm.zhaopinfengmian.split(',w').length>1" class="upload-img" style="margin-right:20px;" v-bind:key="index" :src="ruleForm.zhaopinfengmian" width="100" height="100">
					<img v-else-if="ruleForm.zhaopinfengmian.substring(0,4)=='http'" class="upload-img" style="margin-right:20px;" v-bind:key="index" :src="ruleForm.zhaopinfengmian.split(',')[0]" width="100" height="100">
				...
				<el-form-item v-else class="input" label="职位名称" prop="zhiweimingcheng" >
					<el-input v-model="ruleForm.zhiweimingcheng" placeholder="职位名称" readonly></el-input>
				</el-form-item>
				<el-form-item class="select" v-if="type!='info'"  label="职位类型" prop="zhiweileixing" >
				...
				<el-form-item v-else class="input" label="职位类型" prop="zhiweileixing" >
				...
				<el-form-item class="input" v-if="type!='info'"  label="薪资范围" prop="xinzifanwei" >
					<el-input v-model.number="ruleForm.xinzifanwei" placeholder="薪资范围" clearable  :readonly="ro.xinzifanwei"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="薪资范围" prop="xinzifanwei" >
					<el-input v-model="ruleForm.xinzifanwei" placeholder="薪资范围" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="所属行业" prop="suoshuxingye" >
					<el-input v-model="ruleForm.suoshuxingye" placeholder="所属行业" clearable  :readonly="ro.suoshuxingye"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="所属行业" prop="suoshuxingye" >
					<el-input v-model="ruleForm.suoshuxingye" placeholder="所属行业" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="福利待遇" prop="fulidaiyu" >
					<el-input v-model="ruleForm.fulidaiyu" placeholder="福利待遇" clearable  :readonly="ro.fulidaiyu"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="福利待遇" prop="fulidaiyu" >
					<el-input v-model="ruleForm.fulidaiyu" placeholder="福利待遇" readonly></el-input>
				</el-form-item>
			...
			<el-form-item class="textarea" v-if="type!='info'" label="公司简介" prop="gongsijianjie" >
				<el-input
			...
			<el-form-item v-else-if="ruleForm.gongsijianjie" label="公司简介" prop="gongsijianjie" >
				<span class="text">{{ruleForm.gongsijianjie}}</span>
			</el-form-item>
