			...
			<template >
				...
				<el-form-item class="date" v-if="type!='info'" label="应聘日期" prop="yingpinriqi" >
					<el-date-picker
						...
						type="date"
						:readonly="ro.yingpinriqi"
						placeholder="应聘日期"
					></el-date-picker> 
				</el-form-item>
				<el-form-item class="input" v-else-if="ruleForm.yingpinriqi" label="应聘日期" prop="yingpinriqi" >
					<el-input v-model="ruleForm.yingpinriqi" placeholder="应聘日期" readonly></el-input>
				</el-form-item>
