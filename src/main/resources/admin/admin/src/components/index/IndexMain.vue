<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"130px 0 0 250px","margin":"0","position":"relative","background":"#F0F0F0","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"padding":"0 20px 0","alignItems":"center","color":"#fff","display":"flex","justifyContent":"center","top":"0","left":"0","background":"#62A0DC","gap":"20px","width":"100vw","fontSize":"16px","position":"fixed","zIndex":"999","height":"130px"}'></index-header>
			...
			<template v-if="'vertical' == 'vertical'">
			  ...
			  <template v-if="2 == 2">
				<index-aside :is-collapse="isCollapse" @oncollapsechange="collapseChange" :style='isCollapse ? {"boxShadow":"1px 0 6px  rgba(64, 158, 255, .3)","overflow":"hidden","top":"0","left":"0","background":"#304156","bottom":"0","width":"64px","fontSize":"0px","position":"fixed","transition":"width 0.3s","height":"100%","zIndex":"1001"} : {"boxShadow":"none","padding":"53px 0 0","bottom":"0","transition":"width 0.3s","overflow":"hidden","top":"130px","borderRadius":"0","left":"0","background":"url(http://codegen.caihongy.cn/20241013/9952f03f5c7e4480994ac79718dfeeae.webp) no-repeat","width":"250px","fontSize":"15px","position":"fixed","height":"calc(100vh - 130px)","zIndex":"1001"}'></index-aside>
			  </template>
			</template>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"20px 40px","margin":"0","borderColor":"#3b6885","borderWidth":"0 0 0px 0","background":"#E2E2E2","width":"100%","fontSize":"16px","borderStyle":"solid"}' class="bread-crumbs"></bread-crumbs>
